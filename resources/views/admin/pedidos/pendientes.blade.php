...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Panel de Pedidos Pendientes</h5>
            <p class="mb-0">
                En esta sección podrás gestionar los pedidos pendientes. Puedes revisar los detalles de cada pedido y actualizar su estado a "Entregado" 
                una vez que haya sido procesado. Asegúrate de verificar toda la información antes de marcar un pedido como completado.
            </p>
        </div>
    </div>
</div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('dashboard.admin.entregar', $pedido->id) }}" method="POST">
                            @csrf
                            <button class="btn btn-success" type="submit">Entregar Pedido</button>
                        </form>
                    </div>
                </div>
            </div>
