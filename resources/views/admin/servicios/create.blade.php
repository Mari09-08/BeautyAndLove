...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Crear Servicio</h5>
                <form action="{{ route('dashboard.admin.servicios.store') }}" method="POST">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" id="tiempo" class="form-control @error('tiempo') is-invalid @enderror" name="tiempo" value="{{ old('tiempo') }}">
