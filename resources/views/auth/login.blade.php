                                ...
                                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-2 text-center ms-auto">
                                            <a class="btn btn-link px-3" href="https://www.instagram.com/nails_beautyandlove/">
                                        ...
                                        <div class="col-2 text-center me-auto">
                                            <a class="btn btn-link px-3" href="{{ route('register') }}">
                                ...
                                <form method="POST" action="{{ route('login') }}" role="form" class="text-start">
                                    ...
                                    <p class="mt-4 text-sm text-center">
                                        ...
                                        <a href="{{ route('register') }}"
                                            class="text-primary text-gradient font-weight-bold">Regístrate ahora</a>
                                    </p>
                                </form>
                            </div>
                        </div>
